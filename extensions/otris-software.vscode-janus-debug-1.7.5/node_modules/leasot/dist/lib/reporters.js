...
const loadReporter = (reporter) => {
    ...
    if (reporter in definitions_1.BuiltinReporters) {
        const reporterPath = (0, path_1.join)(__dirname, './reporters', reporter);
        const reporterFac = require(reporterPath).reporter;
        return (0, exports.loadReporter)(reporterFac);
    }
    try {
        // external reporter
        return (0, exports.loadReporter)(require(reporter).reporter);
    }
    catch (err) {
...
const report = (items, reporter = definitions_1.BuiltinReporters.raw, config = {}) => {
    const reporterFn = (0, exports.loadReporter)(reporter);
