...
const parserFactory = ({ customTags }) => {
    const regex = (0, utils_1.getRegex)(customTags);
    ...
    return function parse(contents, file) {
        const comments = [];
        (0, eol_1.split)(contents).forEach(function (line, index) {
            ...
            while (hamlRubyCommentMatch) {
                const comment = (0, utils_1.prepareComment)(hamlRubyCommentMatch, index + 1, file);
                if (!comment) {
                    break;
                }
            ...
            while (hamlHtmlCommentMatch) {
                const comment = (0, utils_1.prepareComment)(hamlHtmlCommentMatch, index + 1, file);
                if (!comment) {
                    break;
                }
                comments.push(comment);
            ...
            while (erbCommentMatch) {
                const comment = (0, utils_1.prepareComment)(erbCommentMatch, index + 1, file);
                if (!comment) {
                    break;
                }
                comments.push(comment);
            ...
            while (htmlCommentMatch) {
                const comment = (0, utils_1.prepareComment)(htmlCommentMatch, index + 1, file);
                if (!comment) {
                    break;
                }
                comments.push(comment);
