 ...
 */
const associateExtWithParser = (extendedDb) => {
 ...
 */
const isExtensionSupported = (extension) => parsersDb.hasOwnProperty(extension);
...
const parse = (content, config) => {
    ...
    (0, exports.associateExtWithParser)(associateParser);
    if (!(0, exports.isExtensionSupported)(extension)) {
