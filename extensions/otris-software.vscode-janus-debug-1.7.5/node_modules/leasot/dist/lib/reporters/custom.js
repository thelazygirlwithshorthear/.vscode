...
const reporter = (todos, config) => {
    const parsedConfig = (0, exports.prepareConfig)(reporterConfig, config);
    const output = (0, exports.getTransformedComments)(todos, parsedConfig);
    return (0, exports.joinBlocksByHeaders)(output, parsedConfig);
};
