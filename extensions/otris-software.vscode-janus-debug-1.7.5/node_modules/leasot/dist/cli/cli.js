...
const getFiletype = (filetype, filename) => {
    ...
    if (filename && (0, path_1.extname)(filename)) {
        return (0, path_1.extname)(filename);
    }
    return DEFAULT_EXTENSION;
};
exports.getFiletype = getFiletype;
const parseContentSync = (content, options, filename) => {
    const extension = (0, exports.getFiletype)(options.filetype, filename);
    (0, __1.associateExtWithParser)(options.associateParser);
    if (!(0, __1.isExtensionSupported)(extension)) {
    ...
    return (0, __1.parse)(content, config);
};
const parseAndReportFiles = (fileGlobs, options) => {
    ...
    (0, async_1.mapLimit)(files, CONCURRENCY_LIMIT, (file, cb) => (0, fs_1.readFile)((0, path_1.resolve)(process.cwd(), file), 'utf8', cb), (err, results) => {
        if (err) {
            console.log(err);
            process.exit(1);
        }
        ...
        (0, common_1.outputTodos)(todos, options);
    });
};
const run = (program) => {
