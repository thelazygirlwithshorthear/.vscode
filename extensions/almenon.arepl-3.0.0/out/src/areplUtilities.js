...
class areplUtils {
    ...
    static getPythonPath() {
        return __awaiter(this, arguments, void 0, function* (resource = null) {
            var _a, _b;
            // see bottom of file for license
            // adapted from vscode-restructuredtext/vscode-restructuredtext#224
            const extension = vscode.extensions.getExtension('ms-python.python');
            if (!extension) {
                const pythonPath = (0, settings_1.settings)().get('pythonPath');
    ...
    static insertDefaultImports(editor) {
        return editor.edit((editBuilder) => {
            let imports = (0, settings_1.settings)().get("defaultImports");
